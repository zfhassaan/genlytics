...
class RestTransport implements TransportInterface
{
     ...
     * }
     * @return \Google\ApiCore\Transport\RestTransport
     ...
     * {@inheritdoc}
     */
    public function startUnaryCall(Call|\Google\ApiCore\Call $call, array $options)
    {
     ...
     */
    public function startServerStreamingCall(Call|\Google\ApiCore\Call $call, array $options)
    {
